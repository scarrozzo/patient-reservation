...
INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      ...
                                      login_enabled, is_patient, is_doctor)
VALUES (2, 0, '5b286c35-73c5-39ab-980d-e24fbd4b63e1', 'Liquibase', 'Liquibase', '2022-12-09', '16:24:36', '2022-12-09',
        ...
        'SOCIAL_SECURITY_NUMBER', 'Gregory', 'House', '1980-10-10', 1, 0, 1);

INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      last_modified_date, last_modified_time, username, password_hash,
                                      patient_identifier, patient_identifier_type, first_name, last_name, date_of_birth,
                                      login_enabled, is_patient, is_doctor)
VALUES (3, 0, '20ab2424-492c-3c05-9bd6-46e4af8adb25', 'admin', 'admin', '2022-12-09', '17:35:50', '2022-12-09',
        '17:35:50', 'patient1', '$2a$10$TVMpM9TLKc/u2KVaz/pFguRotYPg/rAmhMY288AVUlLIWAF/MFoo6', '500-80-1111',
        'SOCIAL_SECURITY_NUMBER', 'Mario', 'Bianchi', '1990-11-01', 1, 1, 0);

INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      last_modified_date, last_modified_time, username, password_hash,
                                      patient_identifier, patient_identifier_type, first_name, last_name, date_of_birth,
                                      login_enabled, is_patient, is_doctor)
VALUES (4, 0, 'a4c09e1f-9d0e-3337-8037-f22264998588', 'admin', 'admin', '2022-12-09', '17:36:25', '2022-12-09',
        '17:36:25', 'patient2', '$2a$10$U5K22nX4vdV7Ogh.S9AfN.EfCicSkiELBJXkcU3PyCu2OC/KDL4Qa', '500-80-1112',
        'SOCIAL_SECURITY_NUMBER', 'Marco', 'Verdi', '1995-03-22', 0, 1, 0);

INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      last_modified_date, last_modified_time, username, password_hash,
                                      patient_identifier, patient_identifier_type, first_name, last_name, date_of_birth,
                                      login_enabled, is_patient, is_doctor)
VALUES (5, 0, 'bf5aa05e-9f00-3e96-b4a5-a61ca9b9105c', 'admin', 'admin', '2022-12-09', '17:36:56', '2022-12-09',
        '17:36:56', 'patient3', '$2a$10$zGDQSP/Y4h/6AoEmibyF1.iN75LFmxiPqKL5Fqs4pwcPiC6mhulsq', '500-80-1113',
        'SOCIAL_SECURITY_NUMBER', 'Giuseppe', 'Neri', '1997-04-15', 1, 1, 0);

INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      last_modified_date, last_modified_time, username, password_hash,
                                      patient_identifier, patient_identifier_type, first_name, last_name, date_of_birth,
                                      login_enabled, is_patient, is_doctor)
VALUES (6, 0, 'c2ba5731-d620-39c1-947e-de275f424062', 'admin', 'admin', '2022-12-09', '17:37:23', '2022-12-09',
        '17:37:23', 'patient4', '$2a$10$mc4cG6fbCCXYG7YYudoe3.3L8T29LZb5uUbby2vk.6cylYWuLhblO', '500-80-1114',
        'SOCIAL_SECURITY_NUMBER', 'Rossana', 'Rossi', '2000-06-29', 1, 1, 0);

INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      last_modified_date, last_modified_time, username, password_hash,
                                      patient_identifier, patient_identifier_type, first_name, last_name, date_of_birth,
                                      login_enabled, is_patient, is_doctor)
VALUES (7, 0, '66223615-5ff3-3b56-ac5f-bcd6de90caf9', 'admin', 'admin', '2022-12-09', '17:37:45', '2022-12-09',
        '17:37:45', 'patient5', '$2a$10$Y4WQyLduINC5L82RD9crqOzlAai97a5yNf0X5d5dWhGZGlpZ4rd/S', '500-80-1115',
        'SOCIAL_SECURITY_NUMBER', 'Romano', 'Tedeschi', '2000-06-29', 1, 1, 0);

INSERT INTO patient_reservation.user (id, version_, uid, creator, modifier, created_date, created_time,
                                      last_modified_date, last_modified_time, username, password_hash,
                                      patient_identifier, patient_identifier_type, first_name, last_name, date_of_birth,
                                      login_enabled, is_patient, is_doctor)
VALUES (8, 0, '1d40269e-a7af-387c-b2c8-ad13a4c65a4b', 'admin', 'admin', '2022-12-09', '17:38:14', '2022-12-09',
        '17:38:14', 'patient6', '$2a$10$RCPK0YKDf5GuI2U6PwHUUuNRYx9Fc9L2yKEK3DBxhEWTNvJeqlOiK', '500-80-1116',
        'SOCIAL_SECURITY_NUMBER', 'Francesco', 'Carrozzo', '2000-06-29', 1, 1, 0);
